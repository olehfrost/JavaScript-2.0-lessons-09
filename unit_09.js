...
function f5() {
    ...
    let elem = out1.classList.contains('bg-orange');
...
function f6() {
    ...
    let elem = document.querySelectorAll('.p-6');
    out.textContent = elem.length;
}
...
function f19() {
    ...
    for (i = 0; i < elem.length; i++) {
        data += elem[i].getAttribute('data-b') + ' ';
    }
